...
public class BaseException extends Exception {
    ...
    private String mErrorDisplayMessage;

    public BaseException() {
    }

    public BaseException(int errorCode, String errorDisplayMessage) {
        mErrorCode = errorCode;
        mErrorDisplayMessage = errorDisplayMessage;
    }

    public BaseException(String message, int errorCode, String errorDisplayMessage) {
        super(message);
        mErrorCode = errorCode;
        mErrorDisplayMessage = errorDisplayMessage;
    }
